...
#define CREATE_WINDOW(win, name) sfRenderWindow_create(win, name, sfClose, NULL)
...
#define IRECT(left, top, width, height) (sfIntRect){left, top, width, height}
#define FRECT(left, top, width, height) (sfFloatRect){left, top, width, height}
